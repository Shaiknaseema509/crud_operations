...
window.location.href = "ecd_view.php"
       ...
       $(document).on('click', '#call', function () {
		...
		var phone_number = $('#alternatenumber').val();
		
		var ConVoxClick_to_call_url ="http://<?=$GLOBALS["host_ip"];?>/ConVox3.0/Agent/bridge.php?ACTION=CALL&user="+agent_id+"&phone_number="+phone_number; 
 ...
 <div class="row">
  ...
  <div class="btns">
      ...
      <!-- <button type="submit"  name="submit" class="btn-2" onclick='return submits();' >SAVE</button>
       ...
       <button type="button" name="submit" id="btn" class="btn btn-success">Submit </button>
